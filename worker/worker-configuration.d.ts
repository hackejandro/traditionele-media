/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config worker/wrangler.jsonc worker/worker-configuration.d.ts` (hash: 802dca6bcf200f59470a985cd3274c6e)
// Runtime types generated with workerd@1.20260515.1 2026-08-31 nodejs_compat
interface __BaseEnv_Env {
	COMMONPLACE: KVNamespace;
	COLLECTOR: DurableObjectNamespace<import("./src/index").CommonplaceCollector>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CommonplaceCollector";
	}
